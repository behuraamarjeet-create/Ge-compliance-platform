...
export interface ApiBidderApplicationBidderApplication
  extends Struct.CollectionTypeSchema {
  collectionName: 'bidder_applications';
  info: {
    displayName: 'Bidder Application';
    pluralName: 'bidder-applications';
    singularName: 'bidder-application';
  };
  options: {
...
export interface ApiIntegrationConfigIntegrationConfig
  extends Struct.CollectionTypeSchema {
  collectionName: 'integration_configs';
  info: {
    displayName: 'Integration Config';
    pluralName: 'integration-configs';
    singularName: 'integration-config';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::integration-config.integration-config'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiVerificationLogVerificationLog
  ...
  info: {
    ...
    pluralName: 'verification-logs';
    singularName: 'verification-log';
  };
  options: {
    draftAndPublish: false;
  };
